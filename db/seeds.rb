...
pin1 = Pin.new({ id: 1, title: 'snake', description: 'black snake', creator_id: 2})
...
pin10 = Pin.new({ id: 10, title: 'sea sunset', description: 'bright sky', creator_id: 3})
